"""
we wanna to change the paramater to understand the 
1. 压缩的原理是什么 ?
2. 使用标准的网络, 问题在于的网络的大小规模的减小
3. MNIST data 的获取为 data.npy
"""
...
def miniNet(width, length, data):
    polygon_data = np.load(data)
    learning_rate = 0.01
    batch_size = 50
