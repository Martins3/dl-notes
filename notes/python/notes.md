1. 返回值是NONE
2. range(n) 下标与python同,生成的是list,所以可以对于其他的通用的list进行for，
3. list.copy() 是 shallow copy
4. list map reduce
5. str(int/double)
6. return value_a if conditions else value_b
7. string 可以成为条件
8. set comprehension 和 ^ -  | & 的集合操作
9. list pop append 尾端元素的处理
10. repr() 和 str() 都是可以将对象string 化，区别尚且不清楚
11. string可以 "hello" * 3 "hello" + "fuck" list 也是具有如此能力
12.
13. star expression 的含义：http://stackoverflow.com/questions/2921847/what-does-the-star-operator-mean
14. 第
15.


1. class 中间的self的使用规则, 所有的成员函数添加？ self.变量名 的形式？
2.
